 ...
 */
final class Version20191020132328 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, email, roles, password, email_verified FROM user');
        ...
        $this->addSql('INSERT INTO user (id, email, roles, password, email_verified) SELECT id, email, roles, password, email_verified FROM __temp__user');
